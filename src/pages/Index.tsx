        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <Button
                className="w-full bg-gradient-to-r from-primary to-primary-dark hover:shadow-[var(--shadow-soft)] transition-all duration-300"
                size="lg"
                onClick={() => window.open("https://www.barobill.co.kr", "_blank")}
              >
              ...
              <Button
                ...
                className="w-full"
                size="lg"
                onClick={() => window.open("https://www.barobill.co.kr/api", "_blank")}
              >
                <ExternalLink className="w-4 h-4 mr-2" />
                바로빌 API 연동하기
              </Button>
